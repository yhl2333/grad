...
if __name__ == "__main__":
    save_track_txt_from_frames(
        model_path="runs/detect/v6.4_n_p2_shanp5_cl3_SimAM_EUCB/weights/best.pt",
        frames_dir="datasetTrack/Multi-Drone-Multi-Object-Detection-and-Tracking/test/1/62-1",
        tracker_config="ultralytics/cfg/trackers/botsort.yaml",
        output_txt="experient_fig/test/droneA_tracks.txt",
        output_reid_npz="experient_fig/test/droneA_reid.npz",
        output_kf_txt="experient_fig/test/droneA_kf.txt",
        conf_thres=0.25,
        iou_thres=0.5,
        classes=[3]
    )