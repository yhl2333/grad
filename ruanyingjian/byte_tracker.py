...
#                 print("gmc_method =", self.args.gmc_method)
#             except Exception:
#                 warp = np.eye(2, 3)
...
#         matches, u_track, _u_detection_second = matching.linear_assignment(dists, thresh=float(self.args.oa_second_match_thresh))
#         for itracked, idet in matches:
